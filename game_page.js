...
function send(){
    ...
    remove_charAt1 = word.replace(charAt1, "_"); //n_kunj 
    remove_charAt2 = remove_charAt1.replace(charAt2, "_"); //n_k_nj
    remove_charAt3 = remove_charAt2.replace(charAt3, "_"); //n_k_n_
